...
* `day1_basics/` – Input, output, simple programs
* `day2_conditionals/` – Decision making programs
* `day3_loops/` – Iteration and logic building
* `day4_strings/` – String manipulation
* `day5_lists/` – List operations

---

## 🎯 Goal

To strengthen problem-solving skills and prepare for backend development using Django.
